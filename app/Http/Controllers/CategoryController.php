...
class CategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($trashed) {
            ...
            $sort = in_array($request->orderby, ['id', 'name', 'products_count']) ? $request->orderby : 'id';
            ...
            if ($sort === 'products_count') {
                $categories->orderBy('products_count', $order);
            } else {
    ...
    public function forceDelete($id)
    {
        ...
        deleteImageFiles($category->image, 'assets/images/categories');
    ...
    public function showCategories(Request $request)
    {
        ...
        $categories = $categories->map(function ($category) {
            $descIds = $category->getAllDescendantIds();
        ...
        if ($sort === 'name') {
            ...
            $categories = $categories->sortBy('created_at')->values();
        } else {

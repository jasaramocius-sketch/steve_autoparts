...
<div class="modal fade" id="impModal_<?php echo e($pickerId); ?>" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body p-3">
        <!-- Selected Preview -->
        <div id="impSelected_<?php echo e($pickerId); ?>" class="d-none mb-3"></div>

        <!-- Search + Upload -->
        <div class="d-flex gap-2 mb-2">
          <div class="flex-grow-1">
            <input type="text" class="form-control form-control-sm" id="impSearch_<?php echo e($pickerId); ?>" placeholder="Search images..." autocomplete="off">
          </div>
          <label class="btn btn-sm btn-outline-primary mb-0" style="cursor:pointer;">
            <i class="fas fa-upload me-1"></i> Upload New
            <input type="file" id="impFileInput_<?php echo e($pickerId); ?>" class="d-none" multiple accept="image/*">
          </label>
        </div>
        ...
        <div class="d-flex gap-2 mb-1">
          <div class="flex-grow-1">
            <input type="url" class="form-control form-control-sm" id="impUrlInput_<?php echo e($pickerId); ?>" placeholder="Provide an image URL to download (optional)" autocomplete="off">
          </div>
          <button type="button" class="btn btn-sm btn-outline-secondary" id="impUrlBtn_<?php echo e($pickerId); ?>">
            <i class="fas fa-download me-1"></i> Download URL
          </button>
        </div>
        <div id="impUrlError_<?php echo e($pickerId); ?>" class="text-danger small d-none mb-2"></div>

        <!-- Upload Progress -->
        <div id="impUploadProgress_<?php echo e($pickerId); ?>" class="d-none mb-3">
        ...
        <!-- Image Grid -->
        <div id="impGrid_<?php echo e($pickerId); ?>" class="imp-grid"></div>

        <!-- Empty State -->
        <div id="impEmpty_<?php echo e($pickerId); ?>" class="imp-empty d-none">
          <i class="fas fa-image fa-3x mb-3 text-muted"></i>
          <p>No images found.</p>
        </div>

        <!-- Pagination -->
        <div id="impPagination_<?php echo e($pickerId); ?>" class="imp-pagination"></div>

        <!-- Multi-select chosen list -->
        <?php if($multiple): ?>
        <div class="mt-3">
          <strong>Selected (<span id="impCount_<?php echo e($pickerId); ?>">0</span>):</strong>
          <div id="impChosen_<?php echo e($pickerId); ?>" class="imp-selected-list"></div>
        </div>
        <?php endif; ?>
      </div>
      <div class="modal-footer py-2">
        <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Cancel</button>
        <button type="button" class="btn btn-primary btn-sm" id="impSelectBtn_<?php echo e($pickerId); ?>" disabled onclick="impConfirm_<?php echo e($pickerId); ?>()">
          <i class="fas fa-check me-1"></i> <?php echo e($multiple ? 'Add Selected' : 'Select Image'); ?>
...
<script>
(function() {
    var pid = '<?php echo e($pickerId); ?>';
    var targetInputName = '<?php echo e($targetInput); ?>';
    var isMultiple = <?php echo e($multiple ? 'true' : 'false'); ?>;
    var apiUrl = '<?php echo e(route("admin.images.picker")); ?>';
    var uploadUrl = '<?php echo e(route("admin.images.picker-store")); ?>';
    var urlStoreUrl = '<?php echo e(route("admin.images.picker-store-url")); ?>';
...
<?php /**PATH /var/www/html/stautoparts/resources/views/admin/partials/image-manager-picker.blade.php ENDPATH**/ ?>
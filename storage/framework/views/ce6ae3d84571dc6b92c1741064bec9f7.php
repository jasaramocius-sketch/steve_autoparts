<?php $__env->startSection('page-id', 'home-page'); ?>
...
<?php if($sections->has('categories_heading')): ?>
        ...
        <div class="mb-30 gs-offer-section-row-first">
            <div class="flex" >
                <div class="gs-title-box flex-column">
                    <h2 class="title wow-replaced"><?php echo e($sections->get('offers')?->title ?? 'Special Offer'); ?></h2>
                ...
                <div class="shop-page-nav flex-column" data-wow-delay=".2s">
                    <a href="<?php echo e(route('shop')); ?>" class="a-tag-hover-color">
                        <?php echo e($sections->get('offers')?->button_text ??  'Shop Now'); ?>
                ...
                <div class="<?php echo e($colClass); ?> wow-replaced" data-wow-delay=".2s">
                    <a href="<?php echo e($banner->button_url ?? route('shop')); ?>" class="">
                        <?php if($banner->image): ?>
                            ...
                            ?>
                            <?php echo imgTag($bannerImg, 'offer banner', 'w-100 h-100 object-fit-cover'); ?>
...
<?php if($sections->has('explore_products')): ?>
...
<?php if($sections->has('deal_of_day')): ?>
<!-- Deal of the Day -->
<section class="gs-deal-of-day gs-deal-of-day-home2">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="deal-of-day-wrapper">
                    <div class="deal-of-day-content">
                        ...
                        <h2 class="title wow-replaced"><?php echo e($deal?->title ?? '!! Special Offer !!'); ?></h2>
                        <h6 class="sub-title wow-replaced" data-wow-delay=".1s"><?php echo e($deal?->subtitle ?? 'CLICK SHOP NOW FOR ALL DEAL OF THE PRODUCT'); ?></h6>
                        <p class="deal-description wow-replaced" data-wow-delay=".2s"><?php echo e($deal?->description ?? 'Donec condimentum Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam at risus nec urna facilisis tincidunt.'); ?></p>
                        <div class="countdown-wrapper flex-wrap " id="countdown">
                            ...
                            ?>
                            <a href="<?php echo e($dealUrl); ?>" class="template-btn steve-btn w-100 wow-replaced" data-wow-delay=".7s"><?php echo e($deal?->button_text ??  'Shop Now'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <input type="hidden" id="countdown-date" value="<?php echo e($deal?->extra_data['countdown'] ?? '2026-12-31T23:59:59'); ?>">
</section>
<!-- Deal of the Day Completed -->
<?php endif; ?>

<?php if($sections->has('featured_products_heading')): ?>
...
<?php if($sections->has('best_selling')): ?>
...
<?php if($sections->has('latest_post')): ?>
<!-- Latest Post Section -->
...
<?php if($sections->has('top_brands_heading')): ?>
<!-- Top Brands Section -->
...
<?php if($sections->has('partners_heading')): ?>
<!-- Partner Section -->

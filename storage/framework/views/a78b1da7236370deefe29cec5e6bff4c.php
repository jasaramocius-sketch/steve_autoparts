<?php $__env->startSection('page-id', 'not-found-page'); ?>
<?php $__env->startSection('page-class', 'not-found-page'); ?>
<?php $__env->startSection('title', '404 - Page Not Found - ' . config('app.name', 'StAutoparts')); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
                <div class="py-5">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="btn text-white steve-btn" style="background-color: var(--primary);">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/stautoparts/resources/views/errors/404.blade.php ENDPATH**/ ?>
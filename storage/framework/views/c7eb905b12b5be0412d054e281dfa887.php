                    ...
                    <tr>
                        ...
                        <td class="pe-3 table-action-col">
                            <div class="action-buttons">
                                <a href="<?php echo e($item->edit_url); ?>" class="action-btn btn-view" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit & Build">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                                </a>
                                <?php if($item->view_url): ?>
                                <a href="<?php echo e($item->view_url); ?>" target="_blank" class="action-btn btn-view-live" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="View Live Page">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/laravel-page-builder/resources/views/admin/page-builder/index.blade.php ENDPATH**/ ?>
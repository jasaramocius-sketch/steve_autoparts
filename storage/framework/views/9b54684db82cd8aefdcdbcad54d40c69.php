<?php $__env->startSection('page-id', 'admin-products-index-page'); ?>
<?php $__env->startSection('page-class', 'admin-products-index-page'); ?>
...
<div class="d-flex justify-content-between align-items-center mb-3 gap-2 flex-wrap">
    ...
    <div class="d-flex gap-2 flex-wrap admin-product-page-important-btn">
        <a href="<?php echo e(route('admin.products.import-form')); ?>" class="btn btn-outline-primary product-import-export-btn steve-btn"><i class="fas fa-upload"></i> Import</a>
...
<ul class="nav nav-tabs mb-3 gap-2 d-flex flex-wrap admin-product-index-nav-tabs">
    ...
    ?>
    <li class="nav-item">
        <a class="nav-link <?php echo e(!request()->has('trashed') ? 'active' : ''); ?>" href="<?php echo e(route('admin.products.index', $activeParams)); ?>">Active</a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?php echo e(request()->has('trashed') ? 'active' : ''); ?>" href="<?php echo e(route('admin.products.index', $trashParams)); ?>">Trash (<?php echo e($trashedCount); ?>)</a>
    </li>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pe-3 table-action-col">
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('admin.products.details', $product->id)); ?>" class="action-btn btn-view" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="View Details"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></a>
                                <a href="<?php echo e(route('admin.products.edit', $product->id)); ?>" class="action-btn btn-edit" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></a>

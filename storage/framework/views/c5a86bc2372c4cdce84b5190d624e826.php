<?php $__env->startSection('page-id', 'user-profile-edit-page'); ?>
<?php $__env->startSection('page-class', 'user-profile-edit-page'); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <a href="<?php echo e(route('user.profile')); ?>" class="btn btn-secondary ms-2 steve-btn">Cancel</a>
                </form>
            </div>
        </div>
    </div>

    ...
    <div class="content-wrapper">
      ...
      <ul class="bread-menu">
        ...
        <?php if(isset($currentCategory)): ?>
          <li><a href="<?php echo e(route('category', ['slug' => $currentCategory->slug])); ?>"><?php echo e($currentCategory->name); ?></a></li>
        <?php endif; ?>
        <?php if(isset($currentSubcategory)): ?>
          <li><a href="<?php echo e(route('subcategory', ['parent' => $currentCategory->slug, 'child' => $currentSubcategory->slug])); ?>"><?php echo e($currentSubcategory->name); ?></a></li>
        <?php endif; ?>
        <?php if(isset($currentChildcategory)): ?>
          <li><a href="javascript:void(0)"><?php echo e($currentChildcategory->name); ?></a></li>
        <?php endif; ?>
      </ul>
    </div>
  </div>

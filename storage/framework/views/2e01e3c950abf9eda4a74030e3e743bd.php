<?php $__env->startSection('page-id', 'shop-page'); ?>
<?php $__env->startSection('page-class', 'shop-page'); ?>
  ...
  <div class="container">
    <div class="row g-4">
                  ...
                  <li class="main-list mb-3">
                    <div class="d-flex justify-content-between align-items-center gap-3">
                      <?php if($topCat->descendant_count > 0 || $isTopActive): ?>
                        <a href="<?php echo e(route('category', ['slug' => $topCat->slug])); ?>" class="text-decoration-none flex-grow-1 primary-a-tag-text-hover" style="color: <?php echo e($isTopActive ? 'var(--primary)' : '#1f0300'); ?>; font-weight: <?php echo e($isTopActive ? '600' : '400'); ?>;">
                          ...
                          <li class="mb-2">
                            <div class="d-flex justify-content-between align-items-center gap-3">
                              <?php if($subCat->descendant_count > 0 || $isSubActive): ?>
                                <a href="<?php echo e(route('subcategory', ['parent' => $topCat->slug, 'child' => $subCat->slug])); ?>" class="text-decoration-none flex-grow-1 primary-a-tag-text-hover" style="color: <?php echo e($isSubActive ? 'var(--primary)' : '#1f0300'); ?>; font-weight: <?php echo e($isSubActive ? '600' : '400'); ?>;">
                                ...
                                <?php $__currentLoopData = $subCat->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  ...
                                  <li class="my-1">
                                    <?php if($childCat->descendant_count > 0 || $isChildActive): ?>
                                      <a href="<?php echo e(route('subcategory', ['parent' => $topCat->slug, 'child' => $subCat->slug, 'subchild' => $childCat->slug])); ?>" class="text-decoration-none a-tag-text-hover" style="color: <?php echo e($isChildActive ? 'var(--primary)' : '#1f0300'); ?>; font-weight: <?php echo e($isChildActive ? '600' : '400'); ?>;">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>            
              <?php if($years->isNotEmpty()): ?>
                ...
                <?php if(request()->hasAny(['year', 'make', 'model'])): ?>
                  <a href="<?php echo e(url()->current()); ?>" class="btn btn-sm w-100 text-white steve-btn">Clear Filter</a>
                <?php endif; ?>
                </div>
      ...
      <div class="col-lg-9 products-grid-area">
        ...
        <?php if($hasSortFilter || $hasBrandFilter || $hasSearchFilter || $hasPriceFilter || $hasYearFilter || $hasMakeFilter || $hasModelFilter || $hasVehicleFilterChip): ?>
          <div class="active-filter-chips d-flex align-items-center flex-wrap gap-2 mb-3">
            ...
            <?php if($hasSearchFilter): ?>
              <span class="filter-chip">
                ...
                <span class="filter-chip-value"><?php echo e(request('search')); ?></span>
                <a href="<?php echo e(request()->fullUrlWithQuery(['search' => null, 'page' => null])); ?>" class="filter-chip-clear" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove search filter">
            ...
            <?php if($hasSortFilter): ?>
              <span class="filter-chip">
                ...
                <span class="filter-chip-value"><?php echo e($activeSortLabel); ?></span>
                <a href="<?php echo e(request()->fullUrlWithQuery(['sort' => null, 'page' => null])); ?>" class="filter-chip-clear" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove sort filter">
                  <i class="las la-times"></i>
                </a>
              </span>
            <?php endif; ?>
            <?php if($hasBrandFilter): ?>
              <span class="filter-chip">
                <span class="filter-chip-label">Brand:</span>
                <span class="filter-chip-value"><?php echo e($activeBrand); ?></span>
                <a href="<?php echo e(request()->fullUrlWithQuery(['brand' => null, 'page' => null])); ?>" class="filter-chip-clear" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove brand filter">
                  <i class="las la-times"></i>
                </a>
              </span>
            <?php endif; ?>
            <?php if($hasPriceFilter): ?>
              <span class="filter-chip">
                ...
                <span class="filter-chip-value">$<?php echo e(number_format($minPriceVal, 0)); ?> - $<?php echo e(number_format($maxPriceVal, 0)); ?></span>
                <a href="<?php echo e(request()->fullUrlWithQuery(['min_price' => null, 'max_price' => null, 'page' => null])); ?>" class="filter-chip-clear" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove price filter">
                  <i class="las la-times"></i>
                </a>
              </span>
            <?php endif; ?>
            <?php if($hasYearFilter): ?>
              <span class="filter-chip">
                <span class="filter-chip-label">Year:</span>
                <span class="filter-chip-value"><?php echo e(request('year')); ?></span>
                <a href="<?php echo e(request()->fullUrlWithQuery(['year' => null, 'page' => null])); ?>" class="filter-chip-clear" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove year filter">
                  <i class="las la-times"></i>
                </a>
              </span>
            <?php endif; ?>
            <?php if($hasMakeFilter): ?>
              <span class="filter-chip">
                <span class="filter-chip-label">Make:</span>
                <span class="filter-chip-value"><?php echo e(request('make')); ?></span>
                <a href="<?php echo e(request()->fullUrlWithQuery(['make' => null, 'page' => null])); ?>" class="filter-chip-clear" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove make filter">
                  <i class="las la-times"></i>
                </a>
              </span>
            <?php endif; ?>
            <?php if($hasModelFilter): ?>
              <span class="filter-chip">
                <span class="filter-chip-label">Model:</span>
                <span class="filter-chip-value"><?php echo e(request('model')); ?></span>
                <a href="<?php echo e(request()->fullUrlWithQuery(['model' => null, 'page' => null])); ?>" class="filter-chip-clear" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove model filter">
                  <i class="las la-times"></i>
                </a>
              </span>
            <?php endif; ?>
            <?php if($hasVehicleFilterChip): ?>
              <?php
                $vehicleMatchCount = $vehicleMatchCount ?? null;
              ?>
              <span class="filter-chip">
                <span class="filter-chip-label">Vehicle:</span>
                <span class="filter-chip-value"><?php echo e($selectedVehicle->year); ?> <?php echo e($selectedVehicle->make); ?> <?php echo e($selectedVehicle->model); ?></span>
                <?php if($vehicleMatchCount !== null): ?>
                  <span class="filter-chip-value" style="color:#6b7280; font-weight:600;"><?php echo e($vehicleMatchCount); ?> part<?php echo e($vehicleMatchCount === 1 ? '' : 's'); ?></span>
                <?php endif; ?>
                <form method="POST" action="<?php echo e(route('shop.clear-vehicle')); ?>" class="d-inline">
                  <?php echo csrf_field(); ?>

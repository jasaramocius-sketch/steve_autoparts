                ...
                <tr>
                    ...
                    <td data-label="Action" class="table-action-col">
                        <div class="action-buttons" style="justify-content:flex-end;">
                            ...
                            <a href="<?php echo e(route('user.orders.show', $order->id)); ?>" class="action-btn btn-view" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="View Details">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                    <circle cx="12" cy="12" r="3"></circle>
                                </svg>
                            </a>
                            <a href="<?php echo e(route('user.orders.invoice', $order->id)); ?>" target="_blank" class="action-btn btn-invoice" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Download Invoice">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">

<?php $__env->startSection('page-id', 'admin-products-create-page'); ?>
<?php $__env->startSection('page-class', 'admin-products-create-page'); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" step="0.01" name="old_price" class="form-control" value="<?php echo e(old('old_price')); ?>">
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" name="stock" class="form-control" value="<?php echo e(old('stock', 0)); ?>" min="0">
                        </div>
                        
                        <div class="col-md-4">
                            <label class="form-label">Badge</label>
                            <input type="text" name="badge" class="form-control" value="<?php echo e(old('badge')); ?>" placeholder="e.g. New, Sale">
                        </div>

                        <div class="col-md-3">
                            <label class="form-label">Section</label>
                            <select name="product_type" class="form-select">
                                <option value="none" <?php echo e(old('product_type') == 'none' ? 'selected' : ''); ?>>None</option>
                                <option value="new_arrival" <?php echo e(old('product_type') == 'new_arrival' ? 'selected' : ''); ?>>New Arrivals</option>
                                <option value="trending" <?php echo e(old('product_type') == 'trending' ? 'selected' : ''); ?>>Trending</option>
                                <option value="best_selling" <?php echo e(old('product_type') == 'best_selling' ? 'selected' : ''); ?>>Best Selling</option>
                                <option value="popular" <?php echo e(old('product_type') == 'popular' ? 'selected' : ''); ?>>Popular</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-check form-switch mt-1">
                                <input type="checkbox" name="featured" value="1" class="form-check-input" id="featured" <?php echo e(old('featured') ? 'checked' : ''); ?>>
                ...
                <div class="tab-pane fade" id="vehicle-details" role="tabpanel" aria-labelledby="vehicle-tab">
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" name="year" class="form-control" value="<?php echo e(old('year')); ?>" min="1900" max="2026" placeholder="e.g. 2020">
                        </div>

                        <div class="col-md-4">
                            <label class="form-label">Make</label>
                            <input type="text" name="make" class="form-control" value="<?php echo e(old('make')); ?>" placeholder="e.g. Toyota">
                        </div>

                        <div class="col-md-4">
                            <label class="form-label">Model</label>
                            <input type="text" name="model" class="form-control" value="<?php echo e(old('model')); ?>" placeholder="e.g. Camry">
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="content-details" role="tabpanel" aria-labelledby="content-tab">
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="tab_label_1" class="form-control" value="<?php echo e(old('tab_label_1')); ?>" placeholder="Description">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Tab 2 Label</label>
                            <input type="text" name="tab_label_2" class="form-control" value="<?php echo e(old('tab_label_2')); ?>" placeholder="Policy">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Tab 3 Label</label>
                            <input type="text" name="tab_label_3" class="form-control" value="<?php echo e(old('tab_label_3')); ?>" placeholder="Reviews">
                        </div>

                        <div class="col-md-12">
                            <label class="form-label">Description</label>
                            <textarea name="description" class="form-control texteditor" rows="4"><?php echo e(old('description')); ?></textarea>
                        </div>
                        
                        <div class="col-md-12">
                            <label class="form-label">Policy Text</label>
                            <textarea name="policy_text" class="form-control texteditor" rows="4"><?php echo e(old('policy_text')); ?></textarea>
                        </div>
                        
                        <div class="col-md-12">
                            <label class="form-label">Key Features</label>
                            <textarea name="features" class="form-control" rows="4" placeholder="Enter one feature per line..."><?php echo e(old('features')); ?></textarea>
                        </div>
                        
                        <div class="col-md-12">
                            <label class="form-label">Reviews Data (JSON array)</label>
                            <textarea name="reviews_data" class="form-control text-monospace" rows="4" placeholder='[{"name":"John","rating":5,"text":"Great product!"}]'><?php echo e(old('reviews_data')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/stautoparts/resources/views/admin/products/create.blade.php ENDPATH**/ ?>
        ...
        <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #0d6efd !important;">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="mb-0 fw-bold"><?php echo e($totalOrders); ?></h3>
                </div>
        ...
        <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #198754 !important;">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="mb-0 fw-bold"><?php echo e(currency_format($totalRevenue)); ?></h3>
                </div>
        ...
        <div class="card border-0 shadow-sm h-100" style="border-left: 4px solid #dc3545 !important;">
            <div class="card-body d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <h3 class="mb-0 fw-bold"><?php echo e($pendingOrders); ?></h3>
                </div>
    ...
    <div class="col-12">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center py-3">
                ...
                <a href="<?php echo e(url('/admin/orders')); ?>" class="a-tag-hover-color">View All<i class="fas fa-arrow-right ms-1"></i></a>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="ps-3 fw-semibold"><?php echo e($order->order_number); ?></td>
                                <td><?php echo e($order->user->name ??  'N/A'); ?></td>
                                <td><?php echo e(currency_format($order->total_amount)); ?></td>
                                <td>
                                    <?php
                                    ...
                                    ?>
                                    <span class="badge <?php echo e($badgeClass); ?> rounded-pill"><?php echo e(ucfirst($order->status)); ?></span>
                                </td>
                                <td class="pe-3 text-muted"><?php echo e($order->created_at->format('M d, Y')); ?></td>
                            </tr>
...
document.addEventListener('DOMContentLoaded', function() {
    var ordersData = <?php echo json_encode($ordersByStatusJson, 15, 512) ?>;
    ...
    ?>
    var currencySymbol = '<?php echo e($curSymbol); ?>';
    ...
    var monthlyRevenueData = <?php echo json_encode($monthlyRevenueJson, 15, 512) ?>;
    var weeklyRevenueData = <?php echo json_encode($weeklyRevenueJson, 15, 512) ?>;
    var dailyRevenueData = <?php echo json_encode($dailyRevenueJson, 15, 512) ?>;
    var hourlyRevenueData = <?php echo json_encode($hourlyRevenueJson, 15, 512) ?>;
    var fiveMinRevenueData = <?php echo json_encode($fiveMinRevenueJson, 15, 512) ?>;
    ...
    if (document.getElementById('monthlyRevenueChart')) {
        ...
        setInterval(function() {
            ...
            if (view === 'hourly' || view === '5min') {
                var range = view;
                fetch('<?php echo e(route("admin.dashboard.today-revenue")); ?>?range=' + range)
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/stautoparts/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>
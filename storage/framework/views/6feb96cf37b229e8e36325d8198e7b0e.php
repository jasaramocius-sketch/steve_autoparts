<?php $__env->startSection('page-id', 'admin-blog-edit-page'); ?>
<?php $__env->startSection('page-class', 'admin-blog-edit-page'); ?>
<?php $__env->startSection('page-title', 'Edit Blog'); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('title', $blog->title)); ?>" required>
...
unset($__errorArgs, $__bag); ?>">
                        <option value="draft" <?php echo e((old('status', $blog->status) ?? 'draft') === 'draft' ? 'selected' : ''); ?>>Draft</option>
                        <option value="published" <?php echo e((old('status', $blog->status) ?? 'draft') === 'published' ? 'selected' : ''); ?>>Published</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__currentLoopData = $blogCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php $__currentLoopData = $cat->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($child->id); ?>" <?php echo e(old('blog_category_id', $blog->blog_category_id ?? '') == $child->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                        rows="10"><?php echo e(old('details', $blog->details)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    <?php if($blog->image): ?>
                        <div class="mt-2">
                            <img src="<?php echo e(asset('assets/images/blogs/' . $blog->image)); ?>" width="80" style="border-radius:4px;">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/stautoparts/resources/views/admin/blogs/edit.blade.php ENDPATH**/ ?>
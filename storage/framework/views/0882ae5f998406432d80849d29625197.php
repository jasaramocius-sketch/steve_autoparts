<?php $__env->startSection('page-id', 'admin-revisions-index-page'); ?>
<?php $__env->startSection('page-class', 'admin-revisions-index-page'); ?>
...
<div class="card border-0 shadow-sm revisions-page-table">
    <div class="card-body p-0">
        <div class="d-flex justify-content-between align-items-center px-3 pt-3 pb-2 flex-wrap flex-md-nowrap mb-3 flex-wrap flex-md-nowrap">
            ...
            <?php echo $__env->make('admin.partials.date-range-filter', ['filterRoute' => 'admin.revisions.index'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="table-action-col">
                            ...
                            <a href="<?php echo e(route('admin.revisions.detail', $rev->id)); ?>" class="btn btn-sm btn-outline-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="View Details">

<?php $__env->startSection('page-id', 'auth-vendor-login-page'); ?>
<?php $__env->startSection('page-class', 'auth-vendor-login-page'); ?>
<?php $__env->startSection('page-title', 'Vendor Login - StAutoparts'); ?>
...
<section class="gs-breadcrumb-section" style="background-image: url('<?php echo e(asset('assets/images/1724480495Imagexxxxxpng.png')); ?>'); background-size: cover; background-position: center;">
  <div class="container">
    <div class="content-wrapper">
      <h2 class="breadcrumb-title">Vendor Login</h2>
      <ul class="bread-menu">
    ...
    <div class="row">
      <div class="col-lg-6 mx-auto reg-area">
        <div class="reg-content">
          ...
          <form action="<?php echo e(route('vendor.login.post')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="form-group">
              <label for="email">Email Address</label>
              <input type="email" name="email" class="form-control" value="vendor@gmail.com" id="email" placeholder="Enter your email" required>
            ...
            <br>
            <p class="login-redirect">Don't have an account? <span><a href="<?php echo e(route('vendor.register')); ?>">Create New Account</a></span></p>
          </form>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/stautoparts/resources/views/auth/vendor-login.blade.php ENDPATH**/ ?>
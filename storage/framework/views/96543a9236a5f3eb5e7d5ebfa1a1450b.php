<?php $__env->startSection('page-id', 'admin-all-brands-page'); ?>
<?php $__env->startSection('page-class', 'admin-all-brands-page'); ?>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pe-3 table-action-col">
                            ...
                            <a href="<?php echo e(route('admin.brands.edit', $brand->id)); ?>" class="action-btn btn-edit" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit">

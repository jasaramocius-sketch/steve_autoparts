<?php $__env->startSection('page-id', 'checkout-payment'); ?>
<?php $__env->startSection('page-class', 'checkout-page payment-step-body bg-light'); ?>
<?php $__env->startSection('title', 'Payment' . ' - ' . config('app.name', 'StAutoparts')); ?>
...
<?php echo $__env->make('partials.checkout-steps', ['activeStep' => 4], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="row">
      <div class="mx-auto">
        <div class="border bg-white p-4 mb-4">
          <div class="row">
          <div class="col-lg-8">
            <form action="<?php echo e(route('checkout.payment.submit')); ?>" class="form-default" role="form" method="POST" id="checkout-form">
              <?php echo csrf_field(); ?>
              ...
              <div class="card rounded-0 border shadow-none">
                ...
                <div class="pt-3 px-4 fs-14 pb-4">
                  ...
                  <a href="<?php echo e(url('/terms')); ?>" class="fw-700">terms and conditions</a>,
                  <a href="<?php echo e(url('/return-policy')); ?>" class="fw-700">return policy</a> &amp;
                  <a href="<?php echo e(url('/privacy-policy')); ?>" class="fw-700">privacy policy</a>
                </div>
              </div>
            </form>
          </div>
          ...
          <div class="col-lg-4 mt-lg-0 mt-4" id="cart_summary">
            <div class="card rounded-0 border shadow-none">
              ...
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr class="cart_item">
                      <td class="product-name pl-0 fs-14 text-dark fw-400 border-top-0 border-bottom">
                        ...
                        <strong class="product-quantity">x <?php echo e($item['qty']); ?></strong>
                      </td>
                      <td class="product-total text-right pr-0 fs-14 text-primary fw-600 border-top-0 border-bottom">
                        <span class="pl-4 pr-0"><?php echo e(currency_format($item['price'] * $item['qty'])); ?></span>
                      </td>
                    </tr>
                ...
                <input type="hidden" id="sub_total" value="<?php echo e($total); ?>">
                  ...
                  <tfoot>
                    <tr class="cart-subtotal">
                      ...
                      <td class="text-right pr-0 fs-14 pb-2 fw-600 text-primary">
                        <span class="fw-600"><?php echo e(currency_format($total)); ?></span>
                      </td>
                    </tr>
                    <tr class="cart-shipping">
                      <th class="pl-0 fs-14 pb-2 text-dark fw-600">Tax</th>
                      <td class="text-right pr-0 fs-14 pb-2 fw-600 text-primary">
                        <span class="fw-600"><?php echo e(currency_format(0)); ?></span>
                      </td>
                    </tr>
                    <tr class="cart-shipping">
                      ...
                      <td class="text-right pr-0 fs-14 pb-2 fw-600 text-primary border-top-0">
                        <span class="fw-600"><?php echo e(currency_format($shippingCost)); ?></span>
                      </td>
                    </tr>
                    <tr class="cart-total">
                      ...
                      <td class="text-right pr-0 fs-14 fw-600 text-primary">
                        <strong><span><?php echo e(currency_format($grandTotal)); ?></span></strong>
                      </td>
                    </tr>
                  </tfoot>
                </table>
          ...
          <div class="row align-items-center cp-actions-row mt-5">
            <div class="col-6 cp-actions-left">
              <a href="<?php echo e(route('home')); ?>" class="btn-link fw-700 px-0 a-tag-hover-color">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/stautoparts/resources/views/payment.blade.php ENDPATH**/ ?>
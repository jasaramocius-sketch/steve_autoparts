...
<li>
        ...
        <div class="tab-product-des-wrapper mt-5 pt-4">
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link steve-btn" id="reviews-tab" data-bs-toggle="tab" data-bs-target="#reviews-tab-pane" type="button" role="tab" aria-controls="reviews-tab-pane" aria-selected="false">Reviews (<?php echo e(collect($product['reviews_data'] ?? [])->where('deleted', false)->count()); ?>)</button>
            </li>
          </ul>
                      ...
                      <div class="d-flex align-items-center gap-2 mb-1">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                          <?php if(($review['user_id'] ?? null) == Auth::id()): ?>
                            <button type="button" class="btn btn-sm btn-outline-danger ms-auto delete-review-btn" data-review-id="<?php echo e($review['id'] ?? ''); ?>" title="Delete review" style="padding:2px 8px;font-size:12px;">

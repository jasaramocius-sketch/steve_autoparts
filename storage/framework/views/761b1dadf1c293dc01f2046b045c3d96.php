<?php $__env->startSection('page-id', 'product-page'); ?>
<?php $__env->startSection('page-class', 'product-page'); ?>
<?php $__env->startSection('title', ($product['name'] ?? 'Product') . ' - ' . config('app.name', 'StAutoparts')); ?>
              ...
              <div class="swiper details_slider_thumb">
                ...
                <?php if($product['image']): ?>
                  <div class="swiper-slide details_slider_thumb_item">
                    <?php echo imgTag('assets/images/thumbnails/' . basename($product['image']), $product['name'], 'img-fluid w-100'); ?>

                  </div>
                <?php endif; ?>
                <?php $__currentLoopData = $galleryImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="swiper-slide details_slider_thumb_item">
                    <?php echo imgTag('storage/' . $gi->path, $product['name'], 'img-fluid w-100'); ?>
          ...
          <div class="col-lg-6">
            <div class="shop_details_text">
              <?php if(isset($product['category']) && $product['category']): ?>
                <p class="category"><?php echo e($product['category']['name'] ?? $product['category']->name); ?></p>
              <?php endif; ?>
              <h2 class="details_title"><?php echo e($product['name']); ?></h2>

              <div class="d-flex flex-wrap align-items-center">
                <p class="stock"><?php echo e($product['stock'] > 0 ? 'In Stock' : 'Out of Stock'); ?></p>
                <?php
                ...
                <p class="rating" id="product-rating">
                  ...
                  <?php endfor; ?>
                  <span id="product-review-count">(<?php echo e($visibleReviews->count()); ?>)</span>
                </p>
              </div>

              <?php if($product->year && $product->make && $product->model): ?>
                <div class="d-flex flex-wrap align-items-center mb-2" style="gap: 8px;">
                  <span class="badge" style="background: #e3f2fd; color: #1565c0; font-size: 13px; font-weight: 500; padding: 6px 12px; border-radius: 6px; margin-top:10px;">
                    <i class="las la-car mr-1"></i> Fits: <?php echo e($product->year); ?> <?php echo e($product->make); ?> <?php echo e($product->model); ?>

                  </span>
                </div>
              <?php endif; ?>

              <?php if(isset($userVehicle) && $userVehicle && $product->year && $product->make && $product->model): ?>
                <div class="mb-2" style="font-size: 13px;">
                  <?php if($vehicleFit): ?>
                    <span style="color: #2e7d32; font-weight: 600;">
                      <i class="las la-check-circle"></i> Fits your <?php echo e($userVehicle->year); ?> <?php echo e($userVehicle->make); ?> <?php echo e($userVehicle->model); ?>

                    </span>
                  <?php else: ?>
                    <span style="color: #c62828; font-weight: 600;">
                      <i class="las la-times-circle"></i> Does not fit your <?php echo e($userVehicle->year); ?> <?php echo e($userVehicle->make); ?> <?php echo e($userVehicle->model); ?>
              ...
              <h3 class="price">
                <?php echo e(currency_format($product['price'])); ?>

                <?php if($product['old_price']): ?>
                  <del><?php echo e(currency_format($product['old_price'])); ?></del>
                <?php endif; ?>
              </h3>

              <div class="short_description" style="line-height: 1.8; color: #4c3533;"><?php echo $product['description'] ?? 'Auctor urna nunc id cursus. Scelerisque purus semper eget duis at pharetra vel turpis nunc eget.'; ?></div>
              ...
              <form action="<?php echo e(route('cart.add')); ?>" method="POST">
                ...
                <div class="d-flex flex-wrap align-items-center">
                  <div class="details_qty_input">
                    ...
                    <input type="text" readonly id="qty" name="qty" value="1" min="1" max="<?php echo e($product['stock']); ?>">
              ...
              <ul class="details_list_btn">
                <li>
                  <form action="<?php echo e(route('wishlist.add')); ?>" method="POST" class="wishlist-form d-inline">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="product_id" value="<?php echo e($product->id); ?>">
                    <button type="button" class="wishlist-btn" style="background:none;border:none;padding:0;font-size:16px;color:#7d7b7b;cursor:pointer;">
                      <i class="<?php echo e($inWishlist ? 'fas' : 'far'); ?> fa-heart"></i> <span><?php echo e($inWishlist ? 'Remove Wishlist' : 'Add Wishlist'); ?></span>
                    </button>
                  </form>
                </li>
                <li>
                  <a href="javascript:;" data-href="<?php echo e(route('compare.add', ['product_id' => $product->id])); ?>" class="compare_product"><i class="fas fa-exchange-alt"></i> Compare</a>
                </li>
<li>
              ...
              <ul class="details_tags_sku">
                <li><span>SKU:</span> WB44721Fdq<?php echo e($product['id']); ?></li>
                <?php if(isset($product['category']) && $product['category']): ?>
                <li><span>Category:</span> <?php echo e($product['category']['name'] ?? $product['category']->name); ?></li>
                <?php endif; ?>
              </ul>
        ...
        <div class="tab-product-des-wrapper mt-5 pt-4">
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <button class="nav-link template-btn steve-btn" id="reviews-tab" data-bs-toggle="tab" data-bs-target="#reviews-tab-pane" type="button" role="tab" aria-controls="reviews-tab-pane" aria-selected="false">Reviews (<?php echo e(collect($product['reviews_data'] ?? [])->where('deleted', false)->count()); ?>)</button>
            </li>
          </ul>
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active py-4" id="description-tab-pane" role="tabpanel" aria-labelledby="description-tab" tabindex="0">
              <div style="line-height: 1.8; color: #4c3533;"><?php echo $product['description'] ?? 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'; ?></div>
            ...
            <div class="tab-pane fade py-4" id="policy-tab-pane" role="tabpanel" aria-labelledby="policy-tab" tabindex="0">
                <div style="line-height: 1.8; color: #4c3533;">
                  <?php echo $product['policy_text'] ?? 'No policy information available.'; ?>
            ...
            <div class="tab-pane fade py-4" id="reviews-tab-pane" role="tabpanel" aria-labelledby="reviews-tab" tabindex="0">
              <div class="review-tab-content-wrapper bg-white p-4 rounded border">
                ...
                <div class="write-review-form mb-4 pb-4 border-bottom" id="writeReviewForm">
                  ...
                  <div class="mb-3">
                    ...
                    <div class="star-picker" id="starPicker">
                      <?php for($i = 1; $i <= 5; $i++): ?>
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="21" viewBox="0 0 17 16" fill="none" data-rating="<?php echo e($i); ?>" style="cursor:pointer;transition:fill .2s;">
                ...
                <!-- Reviews List -->
                <div id="reviewsList">
                <?php $reviews = collect($product['reviews_data'] ?? [])->where('deleted', false); ?>
                <?php $__empty_1 = true; $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <div class="d-flex gap-3 mb-4 pb-3 border-bottom review-item" data-review-id="<?php echo e($review['id'] ?? ''); ?>">
                    <div class="flex-shrink-0">
                      <div class="rounded-circle d-flex align-items-center justify-content-center text-white" style="width: 50px; height: 50px; background: var(--primary); font-weight: 600; font-size: 18px;"><?php echo e(substr($review['name'] ?? '?', 0, 1)); ?></div>
                    </div>
                    <div class="flex-grow-1">
                      <div class="d-flex align-items-center gap-2 mb-1">
                        <h6 class="mb-0 fw-semibold"><?php echo e($review['name'] ?? 'Anonymous'); ?></h6>
                        <small class="text-muted"><?php echo e($review['date'] ?? ''); ?></small>
                        <?php if(auth()->guard()->check()): ?>
                          <?php if(($review['user_id'] ?? null) == Auth::id()): ?>
                            <button type="button" class="btn btn-sm btn-outline-danger ms-auto delete-review-btn" data-review-id="<?php echo e($review['id'] ?? ''); ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Delete review" style="padding:6px 12px;font-size:13px;">
                      ...
                      <div class="mb-1">
                        <?php for($i = 0; $i < 5; $i++): ?>
                          <svg xmlns="http://www.w3.org/2000/svg" width="14" height="13" viewBox="0 0 17 16" fill="none">
                              <path d="M8.5 0.5L10.4084 6.37336L16.584 6.37336L11.5878 10.0033L13.4962 15.8766L8.5 12.2467L3.50383 15.8766L5.41219 10.0033L0.416019 6.37336L6.59163 6.37336L8.5 0.5Z" fill="<?php echo e($i < ($review['rating'] ?? 0) ? '#EEAE0B' : '#E2E8F0'); ?>" />
                          </svg>
                        <?php endfor; ?>
                      </div>
                      <p class="mb-0" style="color: #4c3533;"><?php echo e($review['text'] ?? ''); ?></p>
                      <?php if(!empty($review['images']) && count($review['images']) > 0): ?>
                        <div class="d-flex flex-wrap gap-2 mt-2">
                          <?php $__currentLoopData = $review['images']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(asset($img)); ?>" target="_blank">
                              <img src="<?php echo e(asset($img)); ?>" alt="Review image" style="width:70px;height:70px;object-fit:cover;border-radius:6px;border:1px solid #ddd;">
                            </a>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                      <?php endif; ?>
        ...
        <div class="grid-item">
          <div class="single-product h-100 shadow-sm border overflow-hidden">
            <div class="img-wrapper">
              <a href="<?php echo e(route('product', $rel['slug'])); ?>">
              <?php
                $isWishedRel = in_array($rel->id, $wishedProductIds ?? []);
              ?>
              <form action="<?php echo e(route('wishlist.add')); ?>" method="POST" class="wishlist-form">
                ...
                <button type="button" class="add-to-wishlist-btn wishlist-btn border-0 bg-transparent" data-product-id="<?php echo e($rel->id); ?>">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="<?php echo e($isWishedRel ? 'var(--primary)' : 'none'); ?>" class="wishlist-svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M11.9932 5.13581C9.9938 2.7984 6.65975 2.16964 4.15469 4.31001C1.64964 6.45038 1.29697 10.029 3.2642 12.5604C4.89982 14.6651 9.84977 19.1041 11.4721 20.5408C11.6536 20.7016 11.7444 20.7819 11.8502 20.8135C11.9426 20.8411 12.0437 20.8411 12.1361 20.8135C12.2419 20.7819 12.3327 20.7016 12.5142 20.5408C14.1365 19.1041 19.0865 14.6651 20.7221 12.5604C22.6893 10.029 22.3797 6.42787 19.8316 4.31001C17.2835 2.19216 13.9925 2.7984 11.9932 5.13581Z" stroke="var(--primary)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
                </button>
              </form>
              <div class="product-badges-category">
                <?php if($rel['badge']): ?>
                  <span class="product-badge"><?php echo e($rel['badge']); ?></span>
                <?php endif; ?>
              </div>
              <?php echo imgTag('assets/images/thumbnails/' . basename($rel['image']), $rel['name'], 'product-img'); ?>

              </a>
              <div class="add-to-cart">
                <a href="javascript:void(0)" class="compare compare_product" data-href="<?php echo e(route('compare.add', ['product_id' => $rel['id']])); ?>">
                ...
                <form action="<?php echo e(route('cart.add')); ?>" method="POST" class="d-inline add-cart-form">
                  <?php echo csrf_field(); ?>
                  <input type="hidden" name="product_id" value="<?php echo e($rel['id']); ?>">
                  <input type="hidden" name="product_name" value="<?php echo e($rel['name']); ?>">
                  <input type="hidden" name="product_price" value="<?php echo e($rel['price']); ?>">
                  <input type="hidden" name="product_image" value="<?php echo e($rel['image'] ? asset('assets/images/thumbnails/' . $rel['image']) : asset('assets/images/placeholder.png')); ?>">
                  <button type="submit" class="add-cart border-0 steve-btn">Add to Cart</button>
                </form>
                <a href="<?php echo e(route('product', $rel['slug'])); ?>" class="details">
            ...
            <div class="content-wrapper">
              <h5 class="product-title mb-2">
                <a href="<?php echo e(route('product', $rel['slug'])); ?>" class="text-decoration-none"><?php echo e($rel['name']); ?></a>
              </h5>
              <div class="price-wrapper mb-2">
                <h4><?php echo e(currency_format($rel['price'])); ?></h4>
                <?php if($rel['old_price']): ?>
                  <h4><del><?php echo e(currency_format($rel['old_price'])); ?></del></h4>
                <?php endif; ?>
              </div>
              <div class="ratings-wrapper">
                <?php
                    $displayRating = $rel['rating'] ?? 0;
                    $displayReviews = $rel['reviews'] ?? 0;
                    if ($displayRating == 0 && $displayReviews > 0 && !empty($rel['reviews_data'])) {
                        $visible = collect($rel['reviews_data'])->where('deleted', false);
...
<div class="modal fade" id="contactSellerModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php echo e(route('contact.seller')); ?>" method="POST" id="contactSellerForm">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="product_id" value="<?php echo e($product['id']); ?>">
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control" required maxlength="255" value="<?php echo e(Auth::check() ? Auth::user()->name : ''); ?>">
          </div>
          <div class="mb-3">
            <label class="form-label">Email *</label>
            <input type="email" name="email" class="form-control" required maxlength="255" value="<?php echo e(Auth::check() ? Auth::user()->email : ''); ?>">
          </div>
          <div class="mb-3">
            <label class="form-label">Phone</label>
            <input type="tel" name="phone" class="form-control" inputmode="numeric" maxlength="20" value="<?php echo e(Auth::check() ? Auth::user()->phone ?? '' : ''); ?>">
          </div>
          <div class="mb-3">
...
const maxQty = <?php echo e($product['stock']); ?>;
...
if (submitReviewBtn) {
  submitReviewBtn.addEventListener('click', () => {
    ...
    fetch('<?php echo e(route("product.review", $product->slug)); ?>', {
      method: 'POST',
      headers: {
    ...
    .then(({ status, body }) => {
      if (status === 401) {
        alertEl.className = 'alert alert-danger';
        alertEl.innerHTML = 'Please <a href="<?php echo e(route("login")); ?>">login</a> to write a review.';
        alertEl.classList.remove('d-none');
        ...
        if (review.images && review.images.length > 0) {
          imagesHtml = '<div class="d-flex flex-wrap gap-2 mt-2">' +
            review.images.map(img => '<a href="' + '<?php echo e(asset("/")); ?>' + img + '" target="_blank"><img src="' + '<?php echo e(asset("/")); ?>' + img + '" alt="Review image" style="width:70px;height:70px;object-fit:cover;border-radius:6px;border:1px solid #ddd;"></a>').join('') +
            '</div>';
        }
...
document.addEventListener('click', (e) => {
  ...
  fetch('<?php echo e(route("product.review.delete", ["slug" => $product->slug, "reviewId" => "REVIEW_ID"])); ?>'.replace('REVIEW_ID', reviewId), {
    method: 'DELETE',
    headers: {
      'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
      'X-Requested-With': 'XMLHttpRequest'
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/stautoparts/resources/views/product.blade.php ENDPATH**/ ?>
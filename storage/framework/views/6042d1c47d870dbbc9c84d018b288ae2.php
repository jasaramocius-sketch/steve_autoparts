                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                <form action="<?php echo e(route('admin.pages.toggle-status', $page->id)); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="badge <?php echo e($page->status ? 'bg-light text-success border border-success-subtle' : 'bg-light text-danger border border-danger-subtle'); ?> border-0" style="cursor:pointer;" title="Click to toggle status">
                        ...
                        <td class="pe-3 table-action-col">
                            ...
                            <?php else: ?>
                                <a href="<?php echo e(route('admin.pages.edit', $page->id)); ?>" class="action-btn btn-edit" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></a>

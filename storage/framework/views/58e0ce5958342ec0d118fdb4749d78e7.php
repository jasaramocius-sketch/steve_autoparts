<?php $__env->startSection('page-id', 'admin-file-revisions-page'); ?>
<?php $__env->startSection('page-class', 'admin-file-revisions-page'); ?>
...
<div class="card border-0 shadow-sm file-revisions-table">
    <div class="card-body p-0">
        <div class="d-flex justify-content-between align-items-center px-3 pt-3 pb-2 flex-wrap flex-md-nowrap mb-3 flex-wrap flex-md-nowrap">
            ...
            <?php echo $__env->make('admin.partials.date-range-filter', ['filterRoute' => 'admin.file-revisions.index'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    ...
                    <tr>
                        ...
                        <td class="table-action-col">
                            <div class="d-flex gap-1 action-buttons revision-action-buttons">
                                <a href="<?php echo e(route('admin.file-revisions.diff', $rev->id)); ?>" class="btn btn-sm btn-outline-info steve-btn" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="View Diff">
                                    <i class="fas fa-code-branch"></i>
                                </a>
                                <?php if($rev->backup_path): ?>
                                    <a href="<?php echo e(route('admin.file-revisions.download', $rev->id)); ?>" class="btn btn-sm btn-outline-secondary steve-btn" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Download backup">

<?php $__env->startSection('page-id', 'auth-register-page'); ?>
<?php $__env->startSection('page-class', 'auth-register-page'); ?>
<?php $__env->startSection('page-title', 'Register - StAutoparts'); ?>
        ...
        <div class="reg-content">
          ...
          <form action="<?php echo e(route('register.post')); ?>" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" name="name" class="form-control" id="name" placeholder="Enter your full name" value="<?php echo e(old('name')); ?>" required>

              <label for="email">Email Address</label>
              <input type="email" name="email" class="form-control" id="email" placeholder="Enter your email" value="<?php echo e(old('email')); ?>" required>
                ...
                <div class="pass-wrapper" style="position:relative">
                    ...
                    <span style="position:absolute;right:12px;top:50%;transform:translateY(-50%);cursor:pointer;z-index:5" onclick="togglePassword('confirm-password',this)">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                    </span>
                </div>
            </div>
            ...
            <hr></hr>
            <p class="login-redirect">Already have an account? <span><a href="<?php echo e(route('login')); ?>" class="a-tag-text-hover">Sign In</a></span></p>
          </form>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/stautoparts/resources/views/auth/register.blade.php ENDPATH**/ ?>
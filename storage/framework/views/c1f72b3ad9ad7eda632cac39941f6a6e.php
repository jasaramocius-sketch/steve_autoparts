...
<div class="admin-navbar admin-dashboard-header">
    <div class="d-flex align-items-center gap-2">
        ...
        <a href="<?php echo e(url()->previous()); ?>" class="btn btn-outline-secondary steve-btn btn-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Go Back">
            <i class="fas fa-arrow-left"></i>
        </a>
        <div class="page-title"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></div>
    </div>
    <div class="nav-actions">
        <a href="<?php echo e(route('home')); ?>" target="_blank" class="btn btn-sm btn-outline-primary d-none d-md-inline-block" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="View Site">

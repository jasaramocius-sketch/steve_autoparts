<?php $__env->startSection('page-id', 'admin-faqs-create-page'); ?>
<?php $__env->startSection('page-class', 'admin-faqs-create-page'); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('order', 0)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>" rows="6" required><?php echo e(old('answer')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/stautoparts/resources/views/admin/faqs/create.blade.php ENDPATH**/ ?>
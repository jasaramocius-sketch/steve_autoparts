<?php $__env->startSection('page-id', 'admin-edit-brand-page'); ?>
<?php $__env->startSection('page-class', 'admin-edit-brand-page'); ?>
<?php $__env->startSection('page-title', 'Edit Brand'); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name', $brand->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('website', $brand->website)); ?>" placeholder="https://example.com">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    ...
                    <?php if($brand->image): ?>
                        <div class="mt-2">
                            <img src="<?php echo e(asset('assets/images/brands/' . $brand->image)); ?>" width="80" style="border-radius:4px;">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-check mt-2">
                        <input type="checkbox" name="status" value="1" class="form-check-input" id="status" <?php echo e($brand->status ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" rows="4"><?php echo e(old('description', $brand->description)); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/stautoparts/resources/views/admin/brands/edit.blade.php ENDPATH**/ ?>
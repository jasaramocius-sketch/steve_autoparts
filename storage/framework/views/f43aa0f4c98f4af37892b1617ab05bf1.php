...
<body id="<?php echo $__env->yieldContent('page-id', 'default-page-id'); ?>" class="<?php echo $__env->yieldContent('page-class', 'default-body-class'); ?>">
        ...
        <div class="mobile-menu-account px-3 py-2 border-bottom mobile-view-auth-btns mb-2">
            <?php if(Auth::check()): ?>
                ...
                <div class="mt-2 d-flex flex-wrap gap-2">
                    <a href="<?php echo e(route('user.dashboard')); ?>" class="mobile-auth-icon-btn" title="Dashboard"><i class="fas fa-gauge"></i> Dashboard</a>
                    <?php if(!in_array(Auth::user()->role, ['admin', 'master_admin', 'staff'])): ?>
                        <a href="<?php echo e(route('user.orders')); ?>" class="mobile-auth-icon-btn" title="Orders"><i class="fas fa-box"></i> Orders</a>
                    <?php endif; ?>
            ...
            <?php else: ?>
                <div class="d-flex gap-2">
                    <a href="<?php echo e(route('login')); ?>" class="mobile-auth-icon-btn" title="Login"><i class="fas fa-right-to-bracket"></i> Sign In</a>
                    <a href="<?php echo e(route('register')); ?>" class="mobile-auth-icon-btn" title="Register"><i class="fas fa-user-plus"></i> Sign Up</a>
                </div>
            <?php endif; ?>
        </div>
        <nav>
            ...
            <div class="tab-pane fade show active tb-tb" id="main-menu" role="tabpanel"
                ...
                <div class="mobile-menu-widget">
                    <ul class="mobile-nav-menu">
                        <?php $mobileMenu = json_decode(\App\Models\Setting::get('nav_menu', '[]'), true); ?>
                        <?php $__currentLoopData = $mobileMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <li class="<?php echo e($hasChildren ? 'has-children' : ''); ?>">
                                <?php if($hasChildren): ?>
                                    ...
                                    <ul class="mobile-submenu">
                                        <?php $__currentLoopData = $children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <li class="<?php echo e($hasSubChildren ? 'has-children' : ''); ?>">
                                                <?php if($hasSubChildren): ?>
                                                    ...
                                                    <ul class="mobile-submenu">
                                                        <?php $__currentLoopData = $subChildren; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li><a href="<?php echo e(url($sub['url'] ?? '#')); ?>"><?php echo e($sub['label'] ?? ''); ?></a></li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                <?php else: ?>
                                                    <a href="<?php echo e(url($child['url'] ?? '#')); ?>"><?php echo e($child['label'] ?? ''); ?></a>
                                ...
                                <li class="main-list mb-3">
                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                        <?php if($topCat->descendant_count > 0): ?>
                                            <a href="<?php echo e(route('category', $topCat->slug)); ?>" class="text-decoration-none flex-grow-1" style="color: #1f0300; font-weight: 400; font-size: 15px;">
                                    ...
                                    <?php if($topCat->children->count() > 0): ?>
                                        <ul id="mobcat_<?php echo e($topCat->id); ?>" class="collapse ms-3 mt-2 list-unstyled">
                                                ...
                                                <li class="mb-2">
                                                    <div class="d-flex justify-content-between align-items-center gap-3">
                                                        <?php if($subCat->descendant_count > 0): ?>
                                                            <a href="<?php echo e(route('subcategory', ['parent' => $topCat->slug, 'child' => $subCat->slug])); ?>" class="text-decoration-none flex-grow-1" style="color: #1f0300; font-weight: 400; font-size: 15px;">
                                                    ...
                                                    <?php if($subCat->children->count() > 0): ?>
                                                        <ul id="mobcat_<?php echo e($subCat->id); ?>" class="collapse ms-3 mt-1 list-unstyled">
                                                            <?php $__currentLoopData = $subCat->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <li class="my-1">
                                                                    <?php if($childCat->descendant_count > 0): ?>
                                                                        <a href="<?php echo e(route('subcategory', ['parent' => $topCat->slug, 'child' => $subCat->slug, 'subchild' => $childCat->slug])); ?>" class="text-decoration-none" style="color: #1f0300; font-weight: 400; font-size: 14px;">
                ...
                <div class="col">
                    <form class="search-form" action="<?php echo e(route('shop')); ?>" method="GET">
                        <div class="input-group input__group">
                            <input type="text" class="form-control form__control" name="search" placeholder="I am shopping for..." value="<?php echo e(request('search')); ?>">
            ...
            <div class="row footer-row gy-3">
                ...
                <div class="col-lg-2 col-md-6 col-12 quick-links-col">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="<?php echo e(route('home')); ?>" class="text-secondary">Home</a></li>
                        <li class="mb-2"><a href="<?php echo e(route('shop')); ?>" class="text-secondary">Shop</a></li>
                        <li class="mb-2"><a href="<?php echo e(route('categories.index')); ?>" class="text-secondary">Categories</a></li>
                        <li class="mb-2"><a href="<?php echo e(route('brands')); ?>" class="text-secondary">Brands</a></li>
                        <li class="mb-2"><a href="<?php echo e(route('about')); ?>" class="text-secondary">About Us</a></li>
                        <li class="mb-2"><a href="<?php echo e(route('contact')); ?>" class="text-secondary">Contact</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 col-md-6 col-12 customer-service-col">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                <a href="<?php echo e(route('terms.conditions')); ?>" class="text-secondary">
                                    Terms & Conditions
                                </a>
                            </li>

                            <li class="mb-2">
                                <a href="<?php echo e(route('privacy.policy')); ?>" class="text-secondary">
                                    Privacy Policy
                                </a>
                            </li>

                            <li class="mb-2">
                                <a href="<?php echo e(route('return.policy')); ?>" class="text-secondary">
                                    Return Policy
                                </a>
                            </li>

                            <li class="mb-2">
                                <a href="<?php echo e(route('support.policy')); ?>" class="text-secondary">
                                    Support Policy
                                </a>
                            </li>
                        </ul>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <!-- <div class="recent-posts">
                        <a href="#" class="recent-post d-flex text-white gap-2 mb-2">
                            <?php echo imgTag('assets/images/blogs/1730868152organized-automotive-workshop-interior-minjpg.jpg', 'post', '', 'style="width: 50px; height: 50px; object-fit: cover;"'); ?>

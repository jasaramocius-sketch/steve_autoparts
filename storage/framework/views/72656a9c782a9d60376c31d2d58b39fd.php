<?php $__env->startSection('page-id', 'admin-questions-page'); ?>
<?php $__env->startSection('page-class', 'admin-questions-page'); ?>
...
<div class="d-flex justify-content-between align-items-center mb-3 flex-wrap flex-md-nowrap">
    ...
    <form method="GET" class="d-flex gap-2 align-items-center">
        <select name="source" class="form-select w-auto" onchange="this.form.submit()">
            ...
            <option value="product" <?php echo e(request('source') === 'product' ? 'selected' : ''); ?>>Questions</option>
            <option value="contact" <?php echo e(request('source') === 'contact' ? 'selected' : ''); ?>>Inquiries</option>
        </select>
    </form>
</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($contact->product): ?>
                                <a href="<?php echo e(route('product', $contact->product->slug)); ?>" target="_blank" class="text-decoration-none primary-a-tag-text-hover"><?php echo e(Str::limit($contact->product->name, 30)); ?></a>
                            <?php else: ?>
                        ...
                        <td class="pe-3 table-action-col">
                            <div class="action-buttons">
                                <a href="<?php echo e(route('admin.contacts.show', $contact->id)); ?>" class="action-btn btn-view" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="View"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg></a>

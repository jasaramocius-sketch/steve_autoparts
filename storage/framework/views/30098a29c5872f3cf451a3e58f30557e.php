<?php $__env->startSection('page-id', 'admin-settings-footer-page'); ?>
<?php $__env->startSection('page-class', 'admin-settings-footer-page'); ?>
<?php $__env->startSection('page-title', 'Footer Settings'); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.settings.footer.update')); ?>" method="POST" id="footerColsForm">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="footer_columns" id="footerColumnsInput" value="<?php echo e($settings['footer_columns'] ?? '[]'); ?>">
...
<script>
    var footerData = <?php echo $settings['footer_columns'] ?? '[]'; ?>;
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/stautoparts/resources/views/admin/settings/footer.blade.php ENDPATH**/ ?>
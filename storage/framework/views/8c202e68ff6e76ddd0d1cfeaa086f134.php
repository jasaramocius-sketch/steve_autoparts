<?php $__env->startSection('page-id', 'auth-rider-register-page'); ?>
<?php $__env->startSection('page-class', 'auth-rider-register-page'); ?>
<?php $__env->startSection('page-title', 'Rider Register - StAutoparts'); ?>
    ...
    <div class="row">
      <div class="col-lg-6 mx-auto reg-area">
        <div class="reg-content">
          ...
          <form action="<?php echo e(route('rider.register.post')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <br>
            <p class="login-redirect">Already have an account? <span><a href="<?php echo e(route('rider.login')); ?>">Login Now</a></span></p>
          </form>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/stautoparts/resources/views/auth/rider-register.blade.php ENDPATH**/ ?>
<?php $__env->startSection('page-id', 'admin-file-diff-page'); ?>
<?php $__env->startSection('page-class', 'admin-file-diff-page'); ?>
<?php $__env->startSection('page-title', 'File Diff #' . $rev->id); ?>
...
<!-- <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?php echo e(route('admin.file-revisions.index')); ?>" class="btn btn-sm btn-outline-secondary"><i class="fas fa-list"></i> Back to List</a>
</div> -->
...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-body py-3">
        <div class="row g-3">
            <div class="col-md-6">
                <strong>File:</strong>
                <code class="ms-1"><?php echo e($rev->file_path); ?></code>
            </div>
            <div class="col-md-3">
                <strong>Event:</strong>
                ...
                <?php else: ?>
                    <span class="badge bg-secondary ms-1"><?php echo e($rev->event); ?></span>
                <?php endif; ?>
            </div>
            <div class="col-md-3">
                <strong>Date:</strong>
...
<div class="card border-0 shadow-sm">
    <div class="card-header diff-header py-2 d-flex justify-content-between align-items-center">
        <span>
            ...
            <?php if($rev->user): ?>
                <span class="text-muted ms-2 small">by <?php echo e($rev->user->name); ?></span>
            <?php endif; ?>
        </span>
        <?php if($rev->backup_path): ?>
            <a href="<?php echo e(route('admin.file-revisions.download', $rev->id)); ?>" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="diff-content">
        <?php if($rev->diff): ?>
            <?php
                $lines = explode("\n", $rev->diff);
            ?>
            <pre><?php $__currentLoopData = $lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php
    $cls = '';
...
?><span class="<?php echo e($cls); ?>"><?php echo e($line); ?></span>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></pre>
        <?php else: ?>
            <div class="diff-empty">
                ...
                <?php elseif($rev->event === 'deleted'): ?>
                    <i class="fas fa-minus-circle text-danger me-2"></i>File deleted — <a href="<?php echo e(route('admin.file-revisions.download', $rev->id)); ?>">download last backup</a> to view content.
                <?php else: ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/stautoparts/resources/views/admin/file-revisions/diff.blade.php ENDPATH**/ ?>
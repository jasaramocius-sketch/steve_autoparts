<?php $__env->startSection('page-id', 'auth-login-page'); ?>
<?php $__env->startSection('page-class', 'auth-login-page'); ?>
<?php $__env->startSection('page-title', 'Login - StAutoparts'); ?>
      ...
      <div class="col-lg-6 mx-auto reg-area">
        <div class="reg-content">
          ...
          <form action="<?php echo e(route('login.submit')); ?>" method="POST">
            ...
            <div class="row mb-1 mt-2">
              <div class="col d-flex">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="remember" value="1" id="remember_me">
            ...
            <hr></hr>
            <p class="login-redirect">Don't have an account? <span><a href="<?php echo e(route('register')); ?>" class="a-tag-text-hover">Register Now</a></span></p>
          </form>
        </div>
      </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/stautoparts/resources/views/auth/login.blade.php ENDPATH**/ ?>
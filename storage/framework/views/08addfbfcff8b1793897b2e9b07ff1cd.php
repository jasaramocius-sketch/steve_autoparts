<?php $__env->startSection('title', 'Login - StAutoparts'); ?>
      ...
      <div class="col-lg-6 mx-auto reg-area">
        <div class="reg-content">
          ...
          <form action="<?php echo e(route('login.submit')); ?>" method="POST">
            ...
            <br>
            <p class="login-redirect">Don't have an account? <span><a href="<?php echo e(route('register')); ?>">Register Now</a></span></p>
          </form>
        </div>
      </div>
    </div>

<?php $__env->startSection('page-id', 'admin-categories-index-page'); ?>
<?php $__env->startSection('page-class', 'admin-categories-index-page'); ?>
            ...
            <tr class="categoryRow">
                ...
                <td class="table-action-col">
                  <div class="action-buttons">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('admin.categories.edit',$category->id)); ?>" class="action-btn btn-edit" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></a>

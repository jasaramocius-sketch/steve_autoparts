              ...
              <div class="swiper details_slider_thumb">
                ...
                @if($product['image'])
                  <div class="swiper-slide details_slider_thumb_item">
                    {!! imgTag('assets/images/thumbnails/' . basename($product['image']), $product['name'], 'img-fluid w-100') !!}
                  </div>
                @endif
          ...
          <div class="single-product h-100 shadow-sm border overflow-hidden">
            <div class="img-wrapper">
              ...
              <form action="{{ route('wishlist.add') }}" method="POST" class="wishlist-form">
                ...
                <button type="button" class="add-to-wishlist-btn wishlist-btn border-0 bg-transparent" data-product-id="{{ $rel->id }}">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="{{ $isWishedRel ? 'var(--primary)' : 'none' }}" class="wishlist-svg">
              ...
              <div class="add-to-cart">
                ...
                <form action="{{ route('cart.add') }}" method="POST" class="d-inline add-cart-form">
                  ...
                  <input type="hidden" name="product_image" value="{{ $rel['image'] ? asset('assets/images/thumbnails/' . $rel['image']) : asset('assets/images/placeholder.png') }}">

        ...
        <ul class="gs-dashboard-user-sidebar-wrapper nav flex-column p-0">
            <div class="p-4 text-center mb-4 border-bottom position-relative bg-white rounded">
                <span class="avatar avatar-md mb-3">
                    <img src="{{ auth()->user() && auth()->user()->avatar ? asset(auth()->user()->avatar) : asset('assets/images/avatar-place.png') }}" class="image rounded-circle" onerror="this.onerror=null;this.src='{{ asset('assets/images/avatar-place.png') }}';" width="100">
                </span>

...
@section('page-id', 'user-blog-page')
@section('page-class', 'user-blog-page')
@section('title', 'Blog' . ' - ' . config('app.name', 'StAutoparts'))
    ...
    <div class="col-lg-8">
        ...
        <div class="blog-card bg-white shadow-sm rounded overflow-hidden mb-5">
            ...
            <div class="p-4">
                ...
                <p>
                    {{ Str::limit(strip_tags($blog->description),180) }}
                </p>

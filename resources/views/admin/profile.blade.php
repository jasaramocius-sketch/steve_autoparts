            ...
            <div class="card-body">
                <form action="{{ route('admin.profile.update') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="phone" class="form-control text-transform-capitalize" value="{{ $user->phone }}">
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary text-transform-capitalize">Update Profile</button>
                </form>
            </div>
        </div>
    </div>

    ...
    <div class="card-body p-0">
        <div class="d-flex justify-content-between align-items-center px-3 pt-3 pb-2">
            ...
            <div class="text-muted small">
                Showing {{ $pages->firstItem() }}-{{ $pages->lastItem() }} of {{ $pages->total() }}
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <form action="{{ route('admin.pages.toggle-status', $page->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    <button type="submit" class="badge {{ $page->status ? 'bg-light text-success border border-success-subtle' : 'bg-light text-danger border border-danger-subtle' }} border-0" style="cursor:pointer;" title="Click to toggle status">
                        ...
                        <td class="pe-3 table-action-col">
                            ...
                            @else
                                <a href="{{ route('admin.pages.edit', $page->id) }}" class="action-btn btn-edit" title="Edit"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></a>
        ...
        @if($pages->hasPages())
            <div class="d-flex justify-content-center py-3">{{ $pages->links() }}</div>
        @endif
    </div>
</div>

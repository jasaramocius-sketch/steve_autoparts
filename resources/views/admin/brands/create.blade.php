...
@include('partials.page-attributes', ['pageId' => 'admin-brands-create-page', 'pageClass' => 'admin-brands-create-page'])
    ...
    <div class="card-body">
        <form action="{{ route('admin.brands.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-4 d-flex gap-1">
                ...
                <a href="{{ route('admin.brands.index') }}" class="btn btn-primary steve-btn gap-1">Cancel</a>
            </div>
        </form>
    </div>
</div>

                    ...
                    <form action="{{ route('admin.home-page.update', $section->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card mb-3 border-info">
                            <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-sm btn-light" onclick="addTab()">+ Add Tab</button>
                            </div>
                            <div class="card-body" id="tabs-container">
                                ...
                                <div class="tab-row border rounded p-3 mb-3 bg-light">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <button type="button" class="btn btn-sm btn-danger mt-4" onclick="this.closest('.tab-row').remove()">x</button>
                                    </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="file" name="image" id="image" class="form-control @error('image') is-invalid @enderror" 
                                   accept="image/*">
                            <small class="text-muted d-block mt-2">Accepted formats: JPEG, PNG, JPG, GIF, WebP (Max 5MB)</small>
                            @error('image')

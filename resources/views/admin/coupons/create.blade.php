...
@section('page-id', 'admin-coupons-create-page')
@section('page-class', 'admin-coupons-create-page')
        ...
        <form action="{{ route('admin.coupons.store') }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" placeholder="SAVE20" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="min_order_amount" class="form-control @error('min_order_amount') is-invalid @enderror" value="{{ old('min_order_amount') }}">
                    @error('min_order_amount') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="col-md-4">
                    <label class="form-label">Max Uses</label>
                    <input type="number" name="max_uses" class="form-control @error('max_uses') is-invalid @enderror" value="{{ old('max_uses') }}" placeholder="Unlimited if empty">

@extends('layouts.app')
@section('title', 'Rider Login - StAutoparts')
@section('content')
    ...
    <div class="row">
      <div class="col-lg-6 mx-auto reg-area">
        <div class="reg-content">
          ...
          <form action="{{ route('rider.login.post') }}" method="POST">
            @csrf
            ...
            <br>
            <p class="login-redirect">Don't have an account? <span><a href="{{ route('rider.register') }}">Create New Account</a></span></p>
          </form>
        </div>
      </div>
    </div>

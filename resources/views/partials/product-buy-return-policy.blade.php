...
@else
    ...
    <div class="product-policy-body">
        ...
        <h6 class="mb-2" style="font-weight:600;">Buy / Return Policy</h6>
        ...
        <h6 class="mt-3 mb-2" style="font-weight:600;">Eligibility for Return</h6>
        ...
        <h6 class="mt-3 mb-2" style="font-weight:600;">Refunds</h6>
        ...
        <h6 class="mt-3 mb-2" style="font-weight:600;">Return Shipping</h6>

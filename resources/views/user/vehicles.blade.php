    ...
    <div class="card-body d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <div class="d-flex gap-2">
            <div class="action-buttons">
                <button class="action-btn btn-edit" type="button" data-bs-toggle="modal" data-bs-target="#editVehicleModal{{ $vehicle->id }}" data-bs-placement="top" data-bs-title="Edit" title="Edit">
                ...
                <form action="{{ route('user.vehicles.destroy', $vehicle->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Remove this vehicle?')">
                    @csrf @method('DELETE')
                    <button class="action-btn btn-cancel" type="button" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete" title="Delete">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="number" name="year" class="form-control" min="1900" max="2026" value="{{ $vehicle->year }}" required>
                    </div>
                    <div class="mb-3">
